...
class RoadQueueHistoryController extends Controller
{
    ...
    public function index(Request $request): InertiaResponse
    {
        ...
        return Inertia::render('Operations/RoadQueue/History', [
    ...
    public function exportTransactions(Request $request): StreamedResponse
    {
        ...
        return Response::streamDownload(function () use ($records) {
            $handle = fopen('php://output', 'w');
            fputcsv($handle, [
                'ID', 'Container', 'Category', 'Precheck Time (PH)',
                'Elapsed Time', 'Assigned CHE', 'ISO Type', 'O/B Carrier',
                'Freight Kind', 'Line Op', 'FROM', 'TO', 'BAT#',
    ...
    {
        return RoadQueueHighElapsedTransaction::query()
